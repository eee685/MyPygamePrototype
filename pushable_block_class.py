...
class pushable(wall):
    ...
    def push(self, direction, sprites):#block pushing method
        ...
        for sprite in sprites:
            if self.check_for_collision(sprite):
                ...
                break #exit the loop on first collision
    ...
    def draw(self, screen, color=(0, 0, 255)):
        ...
        print(f"block position: {self.x_position}, {self.y_position}") #to see if the block is moving position just not drawing in new position
