...
screen = pygame.display.set_mode((500, 500))  #screen size, width, height
pygame.display.set_caption("Level 1")    #what the game window is called
...
enemies = [
#    enemy(450, 450, 50, 50, 3)  #enemy 1, x_position, y_position, width, length, speed
]
...
walls = [
    ...
    wall(490, 0, 10, 800),  #right border wall
