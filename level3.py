...
enemies = [
    enemy(700, 250, 50, 50, 1)  #enemy 1, x_position, y_position, width, length, speed
]
...
pushable_blocks = [
    pushable(500, 400, 280, 50, 1),  #test block 1; x_axis, y_axis, length, width, speed
    pushable(240, 260, 10, 60, 1),  #test block 2
]
